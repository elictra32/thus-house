...
**ตัดสินใจเองว่าต้องทำภาพไหม** (build + ถ่ายภาพกินเครดิตคลาวด์มากสุด):
- ทำ: หน้าตาเปลี่ยนชัด / หน้าหรือฟอร์มใหม่ที่ผู้ใช้เห็น
- ไม่ทำ: บั๊ก, API/DB/แจ้งเตือน/cron, แก้ข้อความ, ปุ่ม/คอลัมน์เล็กใน Admin → ทดสอบด้วย tsc/lint/build หรือ Playwright แบบ assert ไม่ต้องส่งภาพ
- ก้ำกึ่ง → ถ่ายเฉพาะจุดที่เปลี่ยน 1–2 ภาพ
